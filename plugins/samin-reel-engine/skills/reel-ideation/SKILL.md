...
Read [templates](../../references/templates.md), [voice guide](../../references/voice-guide.md), and the Ideation section of [pipeline operations](../../references/pipeline-operations.md). Load only the selected story bank and relevant voice examples.
